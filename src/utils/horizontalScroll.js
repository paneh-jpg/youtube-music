...
export function initCustomScrolling() {
  ...
  sections.forEach((section) => {
    const scrollContainer = section.querySelector(
      ".js-album-list-container, .js-video-list-container, .js-chip-list-container, .js-playlist-list-container, .js-song-list-container, .js-quick-pick-list-container, .js-featured-container, .js-more-pick-container, .js-lines-container , .js-moods-and-genres-container"
    );
