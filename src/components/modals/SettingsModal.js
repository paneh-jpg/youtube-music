export const SettingsModal = () => {
  return `
    <div class="js-settings-modal fixed inset-0 z-9 hidden">
      ...
      <div
        class="absolute left-1/2 top-1/2 w-[58vw] max-w-5xl h-[72vh]
      ...
      >
        <aside class="w-67.5 bg-[#2f2f2f] border-r border-white/10">
          ...
          <nav class="px-2 pb-4 space-y-1">
            <button
              type="button"
              class="js-tab w-full text-left px-4 py-3 rounded-lg bg-white/10 font-semibold"
              data-tab="profile"
            >
              Đổi thông tin
            </button>
            ...
            <button
              type="button"
              class="js-tab w-full text-left px-4 py-3 rounded-lg hover:bg-white/5 text-white/90"
              data-tab="password"
            >
              Đổi mật khẩu
            </button>
        ...
        <section class="flex-1 relative">
          <button
            type="button"
            class="js-modal-close absolute right-3 top-3 h-10 w-10 rounded-full
              ...
              <form class="js-form-profile space-y-5 max-w-xl">
                <div>
                  ...
                  <input
                    name="name"
                    autocomplete="name"
                    class="js-username w-full rounded-lg bg-[#1f1f1f] border border-white/10
                           px-4 py-3 outline-none focus:border-white/30"
                ...
                <div>
                  ...
                  <input
                    ...
                    type="email"
                    autocomplete="email"
                    class="js-user-email w-full rounded-lg bg-[#1f1f1f] border border-white/10
                           px-4 py-3 outline-none focus:border-white/30"
                ...
                <button
                  type="submit"
                  class="px-5 py-2.5 rounded-full bg-white text-black
                         font-semibold hover:bg-white/90"
                >
                  Lưu thay đổi
                </button>
              </form>
