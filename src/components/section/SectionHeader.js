    ...
    underline ? "cursor-pointer" : "cursor-default"
      ...
      <div class="flex items-center gap-3">
        ...
        ${
          showNav
            ? `
          <button class="swiper-button-prev h-9 w-9 rounded-full border border-white/20 flex items-center justify-center hover:bg-white/10" aria-label="Previous ">
            <span class="material-symbols-outlined text-white text-[20px]">
              chevron_left
            </span>
          </button>

          <button class="swiper-button-next h-9 w-9 rounded-full border border-white/20 flex items-center justify-center hover:bg-white/10" aria-label="Next" >
            <span class="material-symbols-outlined text-white text-[20px]">
              chevron_right
            </span>
          </button>
