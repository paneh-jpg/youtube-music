  ...
  return `
    <div class="bg-linear-to-b from-[#181818] via-[#0f0f0f] to-[#0f0f0f] text-white font-[Inter]">
      ...
      <div id="mainContentWrapper" class="pt-16 md:ml-64 pb-20 min-h-screen">
        <main id="mainContent" class="js-video-content mt-10 mx-15  " >
        <h1 class"text-3xl font-bold py-10 text-[#333]"> Video detail </h1>
        </main>
      </div>
    </div>
  `;
...
export async function initVideosContent(slug) {
  const contentEl = document.querySelector(".js-video-content");
  if (!contentEl) return;
